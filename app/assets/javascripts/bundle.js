...
/***/ function(module, exports, __webpack_require__) {
	...
	KeyListener = __webpack_require__(1);
	var React = __webpack_require__(8);
	var ReactDOM = __webpack_require__(44);
	var OrganKey = __webpack_require__(174);
	var Organ = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var Note = __webpack_require__(175);
	var Tones = __webpack_require__(176);
	var KeyStore = __webpack_require__(177);
	...
	var OrganKey = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement('li', { className: klass, id: this.props.noteName });
	  }
	});
...
/***/ function(module, exports) {
	...
	var Note = function (freq) {
	  this.oscillatorNode = createOscillator(freq * 4);
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      tones.map(function (tone, index) {
	        return React.createElement(OrganKey, { noteName: tone, key: index });
	      })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Recorder = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'recorderbox' },
	      React.createElement(
	        'button',
	        { onClick: this.handleClick, className: "record " + klass },
	        innerText
	      ),
	      React.createElement(
	        'button',
	        { onClick: this.handlePlay, className: 'play' },
	        '▶'
	      )
	    );
	  },
